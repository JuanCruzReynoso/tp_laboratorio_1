...
static Node* getNode(LinkedList* this, int nodeIndex)
{
    ...
    if(this != NULL && nodeIndex >= 0 && nodeIndex < ll_len(this))
    {
        ...
        {
            pNode = pNode->pNextNode;///Por cada iteración, pNode se convierte en pNextNode, por lo que se va recorriendo la lista de nodos
        }
    }
...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this != NULL && nodeIndex >= 0 && nodeIndex <= ll_len(this))
    {
        ...
        if(nodeIndex == 0) ///Caso donde se quiere enlazar el nodo como primer elemento de la lista
        {
            ...
            else ///Caso donde la lista ya poseía nodos enlazados
            {
